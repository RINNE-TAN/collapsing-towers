...
@[simp]
def log_equiv (Γ : TEnv) (e₀ e₁ : Expr) (τ : Ty) (ω : MEffects) : Prop :=
  typing ϵ Γ 𝟚 e₀ τ ⊥ ω ∧
  typing ϵ Γ 𝟚 e₁ τ ⊥ ω ∧
  ∀ 𝓦 γ₀ γ₁,
    log_equiv_env 𝓦 γ₀ γ₁ Γ →
...
lemma log_equiv_value.apply :
  ∀ 𝓦 f₀ arg₀ f₁ arg₁ τ𝕒 τ𝕓 ω,
    log_equiv_value 𝓦 f₀ f₁ (.arrow τ𝕒 τ𝕓 ⊥ ω) →
    log_equiv_value 𝓦 arg₀ arg₁ τ𝕒 →
    log_equiv_expr 𝓦 (.app₁ f₀ arg₀) (.app₁ f₁ arg₁) τ𝕓 :=
  by
  intros 𝓦 f₀ arg₀ f₁ arg₁ τ𝕒 τ𝕓 ω Hsem_value_fun Hsem_value_arg
