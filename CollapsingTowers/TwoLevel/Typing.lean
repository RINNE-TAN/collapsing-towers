...
inductive typing : Env -> Expr -> Ty -> Prop where
  ...
  | lam₁ : ∀ Γ e τ𝕒 τ𝕓, typing (τ𝕒 :: Γ) (open₀ Γ.length e) τ𝕓 -> Γ.length ∉ fv e -> typing Γ (.lam₁ e) (.arrow τ𝕒 τ𝕓)
  |
  lam₂ :
    ∀ Γ e τ𝕒 τ𝕓,
      typing (.rep τ𝕒 :: Γ) (open₀ Γ.length e) (.rep τ𝕓) -> Γ.length ∉ fv e -> typing Γ (.lam₂ e) (.rep (.arrow τ𝕒 τ𝕓))
  ...
  lam𝕔 :
    ∀ Γ e τ𝕒 τ𝕓,
      typing (τ𝕒 :: Γ) (open₀ Γ.length e) (.rep τ𝕓) -> Γ.length ∉ fv e -> typing Γ (.lam𝕔 e) (.rep (.arrow τ𝕒 τ𝕓))
  |
  lets :
    ∀ Γ b e τ𝕒 τ𝕓, typing Γ b τ𝕒 -> typing (τ𝕒 :: Γ) (open₀ Γ.length e) τ𝕓 -> Γ.length ∉ fv e -> typing Γ (.let𝕔 b e) τ𝕓
  |
  let𝕔 :
    ∀ Γ b e τ𝕒 τ𝕓,
      typing Γ b τ𝕒 ->
