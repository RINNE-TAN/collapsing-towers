...
lemma log_equiv_value.trans :
  ...
  case arrow τ𝕒 τ𝕓 φ IH𝕒 IH𝕓 =>
    ...
    cases φ
    case pure =>
      simp only [log_equiv_value] at Hsem_value₀ Hsem_value₁
...
theorem log_equiv_typing.trans :
  ...
  rw [log_equiv_typing] at Hsem₀ Hsem₁
  rw [log_equiv_typing]
  ...
  apply Hsem₁; apply log_equiv_env.trans
  apply log_equiv_env.symm; apply HsemΓ; apply HsemΓ
