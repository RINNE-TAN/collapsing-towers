...
lemma compatibility.lam :
  ...
  simp only [← HEqv₀, HEqz, multi_subst.lam, log_approx_value]
...
lemma compatibility.app₁ :
  ...
  constructor; apply Hτ₁
  intros k γ₀ γ₁ HsemΓ
  have ⟨HSτFun₀, HSτFun₁⟩ := log_approx_env.multi_subst.typing _ _ _ _ _ _ _ HτFun₀ HτFun₁ HsemΓ
  have ⟨HSτArg₀, HSτArg₁⟩ := log_approx_env.multi_subst.typing _ _ _ _ _ _ _ HτArg₀ HτArg₁ HsemΓ
  have ⟨HSτ₀, HSτ₁⟩ := log_approx_env.multi_subst.typing _ _ _ _ _ _ _ Hτ₀ Hτ₁ HsemΓ
  simp at HSτ₀ HSτ₁
  have ⟨Hmulti_wf₀, Hmulti_wf₁⟩ := log_approx_env.multi_wf _ _ _ _ HsemΓ
  rw [log_approx_expr]
...
lemma compatibility.lets :
  ...
  have ⟨HEq₀, HEq₁⟩ := log_approx_env.length _ _ _ _ HsemΓ
  have ⟨HSτ₀, HSτ₁⟩ := log_approx_env.multi_subst.typing _ _ _ _ _ _ _ Hτ₀ Hτ₁ HsemΓ
  have ⟨HSτb₀, HSτb₁⟩ := log_approx_env.multi_subst.typing _ _ _ _ _ _ _ Hτb₀ Hτb₁ HsemΓ
  have ⟨Hlc₀, Hclosed₀⟩ := typing.wf _ _ _ _ _ HSτ₀
  have ⟨Hlc₁, Hclosed₁⟩ := typing.wf _ _ _ _ _ HSτ₁
  simp at HSτ₀ HSτ₁ Hlc₀ Hlc₁ Hclosed₀ Hclosed₁
  rw [log_approx_expr]
...
lemma compatibility.fix₁ :
  ...
  constructor; apply Hτ₁
  intros k γ₀ γ₁ HsemΓ
  have ⟨HSτFix₀, HSτFix₁⟩ := log_approx_env.multi_subst.typing _ _ _ _ _ _ _ HτFix₀ HτFix₁ HsemΓ
  simp only [multi_subst.fix₁, log_approx_expr]
  intros j Hindexj v₀ Hvalue₀ Hstep₀
  --
  --
  -- fix γ₀(f₀) ⇝ ⟦j⟧ v₀
