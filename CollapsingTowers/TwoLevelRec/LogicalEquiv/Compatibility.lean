...
lemma compatibility.lam :
  ...
  have ⟨HG₀, Hτ₀, HG₁, Hτ₁, He⟩ := He
  have Hτ₀ : typing Γ 𝟙 (.lam e₀) (.arrow τ𝕒 τ𝕓 ∅) ∅ := by apply typing.lam; apply Hτ₀; apply Hwbt; apply Hclosed₀
  have Hτ₁ : typing Γ 𝟙 (.lam e₁) (.arrow τ𝕒 τ𝕓 ∅) ∅ := by apply typing.lam; apply Hτ₁; apply Hwbt; apply Hclosed₁
  rw [← grounded.under_opening] at HG₀ HG₁
  constructor; apply HG₀
  constructor; apply Hτ₀
  constructor; apply HG₁
  constructor; apply Hτ₁
  intros k γ₀ γ₁ HsemΓ
  have ⟨Hτ₀, Hτ₁⟩ := log_rel_env.multi_subst.typing _ _ _ _ _ _ _ Hτ₀ Hτ₁ HsemΓ
  have ⟨HG₀, HG₁⟩ := log_rel_env.multi_subst.grounded _ _ _ _ _ _ HG₀ HG₁ HsemΓ
...
lemma compatibility.app₁ :
  ...
  have ⟨HGFun₀, HτFun₀, HGFun₁, HτFun₁, Hf⟩ := Hf
  have ⟨HGArg₀, HτArg₀, HGArg₁, HτArg₁, Harg⟩ := Harg
  have HG₀ : grounded (.app₁ f₀ arg₀) := by constructor; apply HGFun₀; apply HGArg₀
  ...
  constructor; apply Hτ₁
  intros k γ₀ γ₁ HsemΓ
  have ⟨HGFun₀, HGFun₁⟩ := log_rel_env.multi_subst.grounded _ _ _ _ _ _ HGFun₀ HGFun₁ HsemΓ
  have ⟨HGArg₀, HGArg₁⟩ := log_rel_env.multi_subst.grounded _ _ _ _ _ _ HGArg₀ HGArg₁ HsemΓ
  have ⟨HG₀, HG₁⟩ := log_rel_env.multi_subst.grounded _ _ _ _ _ _ HG₀ HG₁ HsemΓ
  simp at HG₀ HG₁
  have ⟨Hmulti_wf₀, Hmulti_wf₁⟩ := log_rel_env.multi_wf _ _ _ _ HsemΓ
  rw [log_rel_expr]
  ...
  -- fv₀ @ argv₀ ⇾ ⟦i₂⟧ v₀
  simp at Hstep₀
  have ⟨i₀, i₁, i₂, fv₀, argv₀, HEqj, HvalueFun₀, HvalueArg₀, HstepFun₀, HstepArg₀, Hstep₀⟩ := stepn_indexed.refine.app₁ _ _ _ _ Hvalue₀ HG₀ Hstep₀
  --
  --
  -- γ₀(f₀) ⇾ ⟦i₀⟧ fv₀
  -- Γ ⊧ f₀ ≤𝑙𝑜𝑔 f₁ : τ𝕒 → τ𝕓
  ...
  . simp
    -- left
    apply stepn.trans
    apply stepn.grounded.congruence_under_ctx𝔹 _ _ _ (ctx𝔹.appl₁ _ _) HGFun₁ HstepFun₁
    apply lc.under_multi_subst; apply Hmulti_wf₁
    apply typing.regular; apply HτArg₁
    -- right
    apply stepn.trans
    apply stepn.grounded.congruence_under_ctx𝔹 _ _ _ (ctx𝔹.appr₁ _ HvalueFun₁) HGArg₁ HstepArg₁
    -- head
    apply Hstep₁
  . apply log_rel_value.antimono
    apply Hsem_value; omega
...
lemma compatibility.lets :
  ...
  have ⟨HGb₀, Hτb₀, HGb₁, Hτb₁, Hb⟩ := Hb
  have ⟨HGe₀, Hτe₀, HGe₁, Hτe₁, He⟩ := He
  rw [← grounded.under_opening] at HGe₀ HGe₁
  have HG₀ : grounded (.lets b₀ e₀) := by constructor; apply HGb₀; apply HGe₀
  ...
  constructor; apply Hτ₁
  intros k γ₀ γ₁ HsemΓ
  have ⟨HGb₀, HGb₁⟩ := log_rel_env.multi_subst.grounded _ _ _ _ _ _ HGb₀ HGb₁ HsemΓ
  have ⟨HG₀, HG₁⟩ := log_rel_env.multi_subst.grounded _ _ _ _ _ _ HG₀ HG₁ HsemΓ
  simp at HG₀ HG₁
  have ⟨Hmulti_wf₀, Hmulti_wf₁⟩ := log_rel_env.multi_wf _ _ _ _ HsemΓ
  have ⟨HEq₀, HEq₁⟩ := log_rel_env.length _ _ _ _ HsemΓ
  ...
  -- (x ↦ bv₀, γ₀)(e₀) ⇾ ⟦i₁⟧ v₀
  simp at Hstep₀
  have ⟨i₀, i₁, bv₀, HEqj, HvalueBind₀, HstepBind₀, Hstep₀⟩ := stepn_indexed.refine.lets _ _ _ _ Hvalue₀ HG₀ Hstep₀
  --
  --
  -- γ₀(b₀) ⇾ ⟦i₀⟧ bv₀
  -- Γ ⊧ b₀ ≤𝑙𝑜𝑔 b₁ : τ𝕒 → τ𝕓
  ...
  . simp
    -- left
    apply stepn.trans
    apply stepn.grounded.congruence_under_ctx𝔹 _ _ _ (ctx𝔹.lets _ Hlc₁.right) HGb₁ HstepBind₁
    -- head
    have HEqSubst₁ : opening 0 bv₁ (multi_subst γ₁ e₁) = multi_subst (bv₁ :: γ₁) ({0 ↦ Γ.length} e₁) :=
      by
      rw [multi_subst, ← comm.multi_subst_subst _ _ _ _ _ _ Hmulti_wf₁]
...
lemma compatibility.fix₁.induction :
  ...
  have ⟨HGFix₀, HGFix₁⟩ := log_rel_value.syntactic.grounded _ _ _ _ Hsem_value_fix
  ...
  case succ k IH =>
    ...
    have ⟨HvalueArg₀, HvalueArg₁⟩ := log_rel_value.syntactic.value _ _ _ _ Hsem_value_arg
    have ⟨HGArg₀, HGArg₁⟩ := log_rel_value.syntactic.grounded _ _ _ _ Hsem_value_arg
    have ⟨HτArg₀, HτArg₁⟩ := log_rel_value.syntactic.typing _ _ _ _ Hsem_value_arg
    have ⟨HlcArg₀, HclosedArg₀⟩ := typing.wf _ _ _ _ _ HτArg₀
    have ⟨HlcArg₁, HclosedArg₁⟩ := typing.wf _ _ _ _ _ HτArg₁
    rw [log_rel_expr]
    ...
    have ⟨i, HEqj, Hstep₀⟩ := stepn_indexed.refine.fix₁.induction _ _ _ _ HvalueFix₀ HvalueArg₀ Hvalue₀ (by simp; apply HGFix₀) Hstep₀
    --
    --
    -- f₀ @ (λx.f₀ @ fix f₀ @ x) @ argv₀ ⇾ ⟦i⟧ v₀
    -- ——————————————————————————————————————————
    ...
    have ⟨i₀, z, i₁, fv₀, r₀, HEqj, HvalueFun₀, _, HstepFun₀, HstepArg₀, Hstep₀⟩ :=
      stepn_indexed.refine.app₁ _ _ _ _ Hvalue₀ (by simp; constructor; apply HGFix₀; apply HGArg₀) Hstep₀
    ...
    . -- head₀
      ...
      -- head₁
      apply stepn.multi
      apply step.grounded.congruence_under_ctx𝔹 _ _ _ (ctx𝔹.appl₁ _ (lc.value _ HvalueArg₁)) (by simp; apply HGFix₁)
      apply step.grounded.congruence_under_ctx𝔹 _ _ _ (ctx𝔹.appr₁ _ HvalueFix₁) (by simp; apply HGFix₁)
      apply step_lvl.pure id; apply ctx𝕄.hole
      apply HlcFix₁
      apply head.fix₁; apply HvalueFix₁
      -- left
      apply stepn.trans
      apply stepn.grounded.congruence_under_ctx𝔹 _ _ _ (ctx𝔹.appl₁ _ _) (by simp; apply HGFix₁) HstepFun₁
      apply HlcArg₁
      -- head₂
      apply Hstep₁
    . apply log_rel_value.antimono
...
lemma compatibility.fix₁ :
  ...
  have ⟨HGFix₀, HτFix₀, HGFix₁, HτFix₁, Hf⟩ := Hf
  have Hτ₀ : typing Γ 𝟙 (.fix₁ f₀) (.arrow τ𝕒 τ𝕓 ∅) ∅ := by apply typing.fix₁; simp; rfl; apply HτFix₀
  have Hτ₁ : typing Γ 𝟙 (.fix₁ f₁) (.arrow τ𝕒 τ𝕓 ∅) ∅ := by apply typing.fix₁; simp; rfl; apply HτFix₁
  constructor; apply HGFix₀
  constructor; apply Hτ₀
  constructor; apply HGFix₁
  constructor; apply Hτ₁
  intros k γ₀ γ₁ HsemΓ
  have ⟨HGFix₀, HGFix₁⟩ := log_rel_env.multi_subst.grounded _ _ _ _ _ _ HGFix₀ HGFix₁ HsemΓ
  ...
  -- γ₀(f₀) ⇾ ⟦i₀⟧ fv₀
  -- v₀ = λx.fv₀ @ fix fv₀ @ x
  have ⟨i₀, fv₀, HEqj, HvalueFix₀, HstepFix₀, HEqv₀⟩ := stepn_indexed.refine.fix₁ _ _ _ Hvalue₀ HGFix₀ Hstep₀
  rw [HEqv₀]
  --
  --
  -- γ₀(f₀) ⇾ ⟦i₀⟧ fv₀
  ...
  . -- left
    apply stepn.trans
    apply stepn.grounded.congruence_under_ctx𝔹 _ _ _ ctx𝔹.fix₁ HGFix₁ HstepFix₁
    -- head
